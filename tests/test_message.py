...
class TestMessage(unittest.TestCase):
    def test_when_provided_a_full_message_it_parses_it_into_objects(self):
        ...
        self.assertEqual(message.sources[0].variables[0].longName, 'Example Variable 1')
        self.assertEqual(message.sources[0].variables[0].alias, 'example_alias_1')
        self.assertEqual(message.sources[0].variables[0].groupPath, '/example/path/1')
        ...
        self.assertEqual(message.sources[1].variables[0].longName, 'Example Variable 2')
        self.assertEqual(message.sources[1].variables[0].alias, None)
