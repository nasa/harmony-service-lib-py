...
class TestRequests(unittest.TestCase):
    def test_when_only_basic_auth_requested_it_creates_a_proper_auth_header(self):
        actual = harmony.io._auth_header(config(), include_basic_auth=True)
    ...
    def test_when_provided_an_access_token_it_creates_a_proper_auth_header(self):
        ...
        actual = harmony.io._auth_header(config(), access_token)
    ...
    def test_when_provided_an_access_token_and_basic_auth_requested_it_creates_a_proper_auth_header(self):
        ...
        actual = harmony.io._auth_header(config(), access_token, include_basic_auth=True)
    ...
    def test_when_provided_an_access_token_it_creates_a_nonredirectable_auth_header(self):
        ...
        expected_header = dict([harmony.io._auth_header(config(), access_token)])

        actual_request = harmony.io._request_with_bearer_token_auth_header(config(), url, access_token, None)
